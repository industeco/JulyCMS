          ...
          <tr>
            ...
            <td>
              <div class="jc-operators">
                <a href="/admin/catalogs/{{ $catalog['truename'] }}/edit" title="修改" class="md-button md-fab md-dense md-primary md-theme-default">
                  <div class="md-ripple"><div class="md-button-content"><i class="md-icon md-icon-font md-theme-default">edit</i></div></div>
                </a>
                <a href="/admin/catalogs/{{ $catalog['truename'] }}/reorder" title="重排内容" class="md-button md-fab md-dense md-primary md-theme-default">
                  <div class="md-ripple"><div class="md-button-content"><i class="md-icon md-icon-font md-theme-default">sort</i></div></div>
                </a>
                <a href="/admin/catalogs/{{ $catalog['truename'] }}/translate" title="翻译" class="md-button md-fab md-dense md-theme-default" disabled>
