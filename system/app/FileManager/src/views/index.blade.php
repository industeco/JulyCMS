...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="/theme/admin/vendor/laravel-filemanager/img/72px color.png">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css">
  <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.css">
  <link rel="stylesheet" href="/theme/admin/vendor/laravel-filemanager/css/cropper.min.css">
  <link rel="stylesheet" href="/theme/admin/vendor/laravel-filemanager/css/dropzone.min.css">
  <link rel="stylesheet" href="/theme/admin/vendor/laravel-filemanager/css/mime-icons.min.css">
  <style>{!! \File::get(admin_path('vendor/laravel-filemanager/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script src="/theme/admin/vendor/laravel-filemanager/js/cropper.min.js"></script>
  <script src="/theme/admin/vendor/laravel-filemanager/js/dropzone.min.js"></script>
  <script>
  ...
  <script>{!! \File::get(admin_path('vendor/laravel-filemanager/js/script.js')) !!}</script>
